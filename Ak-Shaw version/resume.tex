...
\namesection{Ayush Kumar}{Shaw}{ \urlstyle{same}\href{http://yourakshaw.com}{yourakshaw.com}\\
\href{mailto:hitme@yourakshaw.com}{hitme@yourakshaw.com} | \href{tel:919831284491}{9831284491}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%     COLUMN ONE
...
\descript{MAKAUT | Aug 2017 - July 2021}
...
\runsubsection{YourAKShaw Inc.}
\descript{| Software Engineering Consultant }
\location{August 2024 - Present | Remote}
% \sectionsep
% \begin{tightemize}
% \item 
% \item 
...
\location{June 2022 - March 2023 | Remote}
\sectionsep
\begin{tightemize}
...
\runsubsection{Wayground (formerly Quizizz)}
